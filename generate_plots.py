...
# # BAR PLOTS
# for env in ['envs:random_maze-v0', 'CartPole-v1']:
...
for env in ['envs:random_maze-v0', 'CartPole-v1', 'MountainCar-v0']:
    ...
    params, rewards = extract_rewards(root, ['model_arch', 'env', 'seed', 'learning_freq', 'target_update_freq', 'seq_len'], filters)

    # plot_rewards(params, rewards, plot=[0,5], plot_fmt='%s, %s', xlabel="Step", ylabel="Average Reward", title=env_rename[env])
